...
coordFeats = ['MM_SCN_avg', 'MM_SCN_3', 'MM_SCN_4', 'MM_SCN_6', 'MM_SCN_7', 'MM_SCN_8', 'MM_SCN_10', 'MM_SCN_12', 'MM_BCN_avg', 'MM_TCN_11', 'MM_TCN_14', 'MM_TCN_15']  # Coordination features
crysFeats = [ 'FCC', 'HCP', 'DECA', 'q6q6_avg_surf', 'q6q6_S_3', 'q6q6_S_12', 'q6q6_B_4', 'q6q6_B_7', 'q6q6_T_11', 'q6q6_T_13']  # Crystallographic features
surfStructFeats = ['S_100', 'S_110', 'S_111', 'S_311', 'Curve_11-20', 'Curve_31-40', 'Curve_41-50']  # Surface structural features
wholeNPfeats = ['Volume', 'N_atom_surface', 'R_diff', 'R_skew', 'R_kurt', 'MM_BL_avg', 'MM_BL_min', 'MMM_BA1_avg']  # Nanoparticle topological features
dBox = ['DBoxEX']
allNodes = synParams + wholeNPfeats + surfStructFeats + coordFeats + crysFeats + dBox
motivationNumDict = {('MM_SCN_10', 'q6q6_T_11'): 49.75, 
                     ('MM_SCN_10', 'HCP'): 39.86, 
                     ('MM_SCN_10', 'q6q6_S_3'): 39.12, 
